...
export default function DashboardPage() {
  ...
  {mockStats.map((stat: { label: string; value: string | number }) => (
          <div key={stat.label} className="bg-white rounded shadow p-4 text-center">
      ...
      <div className="bg-white rounded shadow p-6 mb-8">
        <h2 className="text-xl font-bold mb-4">User Growth (Mock Chart)</h2>
      ...
      <div className="bg-white rounded shadow p-6">
        ...
        <table className="w-full text-left">
          ...
          <tbody>
            {mockTableData.map((row: { id: number; name: string; plan: string; status: string }) => (
